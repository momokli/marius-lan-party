...
> Fast alles auf Steam. "Wir probieren ein paar aus" — diese Liste ist der Pool.
> Server-Setup siehe `LAN-SERVER.md` (Dedicated Server, wenn nötig).
...
- **Sa (Main Event):** lange Coop-Sessions (Factorio, L4D2, CS2) + Turnier
- **So (Ausklang):** Warcraft III Custom Games, entspannte Runden
...
## Genre-Übersicht (für die Queue)

| Genre | Spiele |
|---|---|
| 🏭 **Factory/Coop** | Satisfactory 🔥, Factorio |
